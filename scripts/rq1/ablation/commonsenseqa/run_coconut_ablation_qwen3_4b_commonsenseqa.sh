...
OUTPUT="outputs/rq1/ablation/commonsenseqa_coconut_qwen3_4b.jsonl"
MODES="zero,mean,gaussian_h,gaussian_mu,mean_step,gaussian_mu_step"
MEAN_CACHE="outputs/rq1/mean_latents/commonsenseqa_coconut_qwen3_4b.pt"
# ===========================
...
if [ ! -f "${MEAN_CACHE}" ]; then
  python experiments/rq1/run_step_ablation.py \
    ...
    --only_estimate_mean \
    --output_path "/tmp/commonsenseqa_coconut_qwen3_4b_mean_only.jsonl" \
