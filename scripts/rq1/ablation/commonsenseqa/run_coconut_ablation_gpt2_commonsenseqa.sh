...
DIST_URL="env://"
DIST_BACKEND="nccl"
CONFIG="configs/rq1/coconut/gpt2-commonsenseqa.yaml"
OUTPUT="outputs/rq1/ablation/commonsenseqa_coconut_gpt2.jsonl"
MODES="zero,mean,gaussian_h,gaussian_mu,mean_step,gaussian_mu_step"
MEAN_CACHE="outputs/rq1/mean_latents/commonsenseqa_coconut_gpt2.pt"
# ===========================
...
if [ ! -f "${MEAN_CACHE}" ]; then
  python experiments/rq1/run_step_ablation.py \
    ...
    --only_estimate_mean \
    --output_path "/tmp/commonsenseqa_coconut_gpt2_mean_only.jsonl" \
