...
"""
Quick SoftThinking inference demo.

Usage:
  python scripts/inference/test_softthinking_infer.py \
    --config_path configs/rq1/softthinking/gpt2-gsm8k.yaml \
...
def main() -> None:
    ...
    parser.add_argument("--config_path", required=True, help="Path to SoftThinking config (YAML/JSON).")
    ...
    model = load_model("softthinking", model_cfg)
