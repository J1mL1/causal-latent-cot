...
CONDA_ENV="coconut"
CONFIG="configs/rq3/superposition_coconut_qwen3_1_7b_commonsenseqa.yaml"
INPUT_DIR="outputs/rq3/coconut_qwen3_1_7b-commonsenseqa/ambiguous"
PROBE_DIR="outputs/rq3/coconut_qwen3_1_7b-commonsenseqa/probes"
OUT_JSONL="outputs/rq3/coconut_qwen3_1_7b-commonsenseqa/interventions.jsonl"
