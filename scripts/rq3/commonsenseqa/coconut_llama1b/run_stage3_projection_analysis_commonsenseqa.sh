...
INPUT_DIR="outputs/rq3/coconut_llama1b-commonsenseqa/ambiguous"
PROBE_DIR="outputs/rq3/coconut_llama1b-commonsenseqa/probes"
OUT_JSONL="outputs/rq3/coconut_llama1b-commonsenseqa/projection_scores.jsonl"
