...
CONDA_ENV="coconut"
CONFIG="configs/rq3/superposition_coconut_gpt2_commonsenseqa.yaml"
INPUT_DIR="outputs/rq3/coconut_gpt2-commonsenseqa/ambiguous"
PROBE_DIR="outputs/rq3/coconut_gpt2-commonsenseqa/probes"
OUT_JSONL="outputs/rq3/coconut_gpt2-commonsenseqa/interventions.jsonl"
